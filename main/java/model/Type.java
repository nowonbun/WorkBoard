...
@Entity
@Table(name = "type")
@NamedQueries({@NamedQuery(name = "Type.findAll", query = "SELECT t FROM Type t"), @NamedQuery(name = "Type.findActiveAll", query = "SELECT t FROM Type t WHERE t.isactive=true")})
